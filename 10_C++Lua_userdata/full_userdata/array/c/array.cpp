...
// 检查第一个参数是否是一个有效的数组
// 如果元表类型不对，则会抛出
// .../Lua/Lua_CPP_2022/10_C++Lua_userdata/用户数据/newarray_面向对象.lua:15: bad argument #1 to 'get' (df expected, got Jiang.array)
...
void arrayObjectDemo() {
    ...
    std::string fileName = PROJECT_PATH + "/10_C++Lua_userdata/full_userdata/array/c/array.lua";
